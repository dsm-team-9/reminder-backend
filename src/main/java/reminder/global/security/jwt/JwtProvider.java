...
import reminder.global.error.ExpiredTokenException;
import reminder.global.security.principle.AuthDetailsService;
...
public class JwtProvider {
    ...
    public TokenResponse getToken(User user) {
        String accessToken = generateAccessToken(user.getPhoneNumber());
